...
public final class Sheet implements Iterable<Row> {
     ...
     * @param clientAnchorConsumer clientAnchorConsumer
     * */
    public void addImage(InputStream inputStream, Consumer<ClientAnchor> clientAnchorConsumer) {
        ...
        if (clientAnchorConsumer != null) {
            clientAnchorConsumer.accept(clientAnchor);
        }
